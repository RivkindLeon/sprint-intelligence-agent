...
(0, node_test_1.default)('calculateSprintProgress clamps elapsed days after the sprint ends', () => {
    ...
    node_assert_1.default.strictEqual(summary.projectedCompletedHoursBySprintEnd, 3);
    node_assert_1.default.strictEqual(summary.projectedCompletionRateByHours, 100);
